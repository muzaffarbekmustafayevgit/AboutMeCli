...
const Navbar = () => {
  ...
  return (
    <nav className={`absolute w-full top-0 left-0 z-50 transition-all duration-500 ${
      scrolled 
      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <Link to="/" className="flex items-center space-x-3 group">
          <div className="relative">
           <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 mb-2 shadow-2xl animate-pulse">
